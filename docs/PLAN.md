...
**Status:** Phase 1, Phase 2.5 and **Phase 3 closed** (Steps 0–25 · live `/theme` + `ctrl+t` overlay + colour degradation + input box/footer/autocomplete + syntax highlighting/Chroma + Markdown/Glamour) · **next: Phase 4 (robustness)** — see §17 2026-08-13 for the correction that closed Phase 3 (the "two product visual idea animations" line below was a stale Bitácora artifact, not a real pending item; the cursor-following-eyes animation stays cancelled, deferred indefinitely — see §11 Phase 3)
