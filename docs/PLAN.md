...
**Estado:** Fase 1 y Fase 2.5 cerradas (Pasos 0–25) · Fase 3 en curso · `/theme [nombre]` + overlay `ctrl+t` cerrados (PR #115 completo) · **siguiente: Markdown/Glamour, resaltado de sintaxis/Chroma, o las animaciones de "idea visual"**
