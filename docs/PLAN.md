...
**Status:** Phase 1 and Phase 2.5 closed (Steps 0–25) · Phase 3 in progress · `/theme [name]` + `ctrl+t` overlay + syntax highlighting/Chroma + Markdown/Glamour closed · **next: the two "product visual idea" animations** (the cursor-following-eyes animation is cancelled, deferred indefinitely — see §11 Phase 3)
